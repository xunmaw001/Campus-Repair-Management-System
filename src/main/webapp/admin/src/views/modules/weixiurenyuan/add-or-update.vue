               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工号" prop="weixiurenyuanUuidNumber">
                       <el-input v-model="ruleForm.weixiurenyuanUuidNumber"
                                 placeholder="工号" clearable  :readonly="ro.weixiurenyuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修人员姓名" prop="weixiurenyuanName">
                       <el-input v-model="ruleForm.weixiurenyuanName"
                                 placeholder="维修人员姓名" clearable  :readonly="ro.weixiurenyuanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修人员手机号" prop="weixiurenyuanPhone">
                       <el-input v-model="ruleForm.weixiurenyuanPhone"
                                 placeholder="维修人员手机号" clearable  :readonly="ro.weixiurenyuanPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修人员身份证号" prop="weixiurenyuanIdNumber">
                       <el-input v-model="ruleForm.weixiurenyuanIdNumber"
                                 placeholder="维修人员身份证号" clearable  :readonly="ro.weixiurenyuanIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="weixiurenyuanEmail">
                       <el-input v-model="ruleForm.weixiurenyuanEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.weixiurenyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="weixiurenyuanShanchang">
                       <el-input v-model="ruleForm.weixiurenyuanShanchang"
                                 placeholder="擅长" clearable  :readonly="ro.weixiurenyuanShanchang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="维修人员介绍" prop="weixiurenyuanContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.weixiurenyuanContent" label="维修人员介绍" prop="weixiurenyuanContent">
                            <span v-html="ruleForm.weixiurenyuanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    weixiurenyuanUuidNumber: false,
                    weixiurenyuanName: false,
                    weixiurenyuanPhone: false,
                    weixiurenyuanIdNumber: false,
                    weixiurenyuanPhoto: false,
                    sexTypes: false,
                    weixiurenyuanEmail: false,
                    weixiurenyuanShanchang: false,
                    weixiurenyuanContent: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    weixiurenyuanUuidNumber: new Date().getTime(),
                    weixiurenyuanName: '',
                    weixiurenyuanPhone: '',
                    weixiurenyuanIdNumber: '',
                    weixiurenyuanPhoto: '',
                    sexTypes: '',
                    weixiurenyuanEmail: '',
                    weixiurenyuanShanchang: '',
                    weixiurenyuanContent: '',
                },
                sexTypesOptions : [],
                rules: {
                   username: [
                   ...
                   weixiurenyuanPhone: [
                              {  required: true, message: '维修人员手机号不能为空', trigger: 'blur' },
                   ...
                   weixiurenyuanIdNumber: [
                              { required: true, message: '维修人员身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '维修人员身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   weixiurenyuanPhoto: [
                              { required: true, message: '维修人员头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   weixiurenyuanContent: [
                              { required: true, message: '维修人员介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
