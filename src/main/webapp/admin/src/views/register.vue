<template>
    <div style="backgroundImage: url('/xiaoyuanbaoxiuguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">校园报修管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="维修人员姓名" class="input" v-if="tableName=='weixiurenyuan'">
                            <el-input v-model="ruleForm.weixiurenyuanName" autocomplete="off" placeholder="维修人员姓名"  />
                        </el-form-item>
                        <el-form-item label="维修人员手机号" class="input" v-if="tableName=='weixiurenyuan'">
                            <el-input v-model="ruleForm.weixiurenyuanPhone" autocomplete="off" placeholder="维修人员手机号"  />
                        </el-form-item>
                        <el-form-item label="维修人员身份证号" class="input" v-if="tableName=='weixiurenyuan'">
                            <el-input v-model="ruleForm.weixiurenyuanIdNumber" autocomplete="off" placeholder="维修人员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='weixiurenyuan'">
                            <el-input v-model="ruleForm.weixiurenyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.weixiurenyuanName)&& 'weixiurenyuan'==this.tableName){
                                this.$message.error('维修人员姓名不能为空');
                                return
                            }
                             if('weixiurenyuan' == this.tableName && this.ruleForm.weixiurenyuanPhone&&(!this.$validate.isMobile(this.ruleForm.weixiurenyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.weixiurenyuanIdNumber)&& 'weixiurenyuan'==this.tableName){
                                this.$message.error('维修人员身份证号不能为空');
                                return
                            }
                            if('weixiurenyuan' == this.tableName && this.ruleForm.weixiurenyuanEmail&&(!this.$validate.isEmail(this.ruleForm.weixiurenyuanEmail))){
